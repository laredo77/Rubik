...
export default ({actions, disabled, controlsStatus, isMatch, user, id}) => {
    ...
    return (
        <section className={classNames('Controls', {
            ...
            {/* Spin X forward */}
            <Arrow id={`a41${id}`} slice={3} forward={true}
                   style={{
                       transform: 'translate(150px, 545px) rotate(100deg)',
                       opacity: controlsStatus ? undefined : 0
                       //opacity: 1
                   }}/>
            <Arrow id={`a51${id}`} slice={4} forward={true}
                   style={{
                       transform: 'translate(230px, 535px) rotate(100deg)',
                       opacity: controlsStatus ? undefined : 0
                       //opacity: 1
                   }}/>
            <Arrow id={`a61${id}`} slice={5} forward={true}
                   style={{
            ...
            {/* Spin X backward */}
            <Arrow id={`a40${id}`} slice={3} forward={false}
                   style={{
                       transform: 'translate(50px, -20px) rotate(240deg)',
                       opacity: controlsStatus ? undefined : 0
                       //opacity: 1
                   }}/>
            <Arrow id={`a50${id}`} slice={4} forward={false}
                   style={{
            ...
            <Arrow id={`a60${id}`} slice={5} forward={false}
                   style={{
                       transform: 'translate(230px, -10px) rotate(240deg)',
                       opacity: controlsStatus ? undefined : 0
                   }}/>
            {/* Spin Y forward */}
            <Arrow id={`a71${id}`} slice={6} forward={true}
                   style={{
                       transform: 'translate(500px, 260px)',
                       opacity: controlsStatus ? undefined : 0
                       //opacity: 1
                   }}/>
            <Arrow id={`a81${id}`} slice={7} forward={true}
                   style={{
                       transform: 'translate(480px, 340px)',
                       opacity: controlsStatus ? undefined : 0
                       //opacity: 1
                   }}/>
            <Arrow id={`a91${id}`} slice={8} forward={true}
                   style={{
                       transform: 'translate(460px, 420px)',
                       opacity: controlsStatus ? undefined : 0
                   }}/>
            {/* Spin Y backward */}
            <Arrow id={`a70${id}`} slice={6} forward={false}
                   style={{
                       transform: 'translate(-40px, 30px) rotate(220deg)',
                       opacity: controlsStatus ? undefined : 0
                       //opacity: 1
                   }}/>
            <Arrow id={`a80${id}`} slice={7} forward={false}
                   style={{
                       transform: 'translate(-60px, 130px) rotate(220deg)',
                       opacity: controlsStatus ? undefined : 0
                       //opacity: 1
                   }}/>
            <Arrow id={`a90${id}`} slice={8} forward={false}
                   style={{
            ...
            <div style={{
                position: 'absolute', top: '15px', left: '-140px', transform: 'scale(1.05)',
                opacity: controlsStatus ? undefined : 0
            }}>
