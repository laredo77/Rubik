...
//import recorder from "./buildArrow"

export default ({rotate, recorder}) => (
  <svg className='RotateArrows'
      width='740px' height='650px' viewBox='0 0 727.464 649.468'>
      <g onClick={() => {rotate('x', false); recorder(rotate, 'x', false)}}>
